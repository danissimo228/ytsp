...
class Search(SearchCore):
    ...
    def __init__(self, query: str, limit: int = 20, language: str = 'en', region: str = 'US',
                 timeout: Optional[int] = None, proxy: dict = None,
                 user_agent: str = None):
        self.searchMode = (True, True, True)
        super().__init__(query, limit, language, region, None, timeout, proxy, user_agent)  # type: ignore
...
class VideosSearch(SearchCore):
    ...
    def __init__(self, query: str, limit: int = 20, language: str = 'en', region: str = 'US',
        ...
        super().__init__(query, limit, language, region, SearchMode.videos, timeout, proxy, user_agent)  # type: ignore
...
class ChannelsSearch(SearchCore):
    ...
    def __init__(self, query: str, limit: int = 20, language: str = 'en', region: str = 'US',
        ...
        super().__init__(query, limit, language, region, SearchMode.channels, timeout, proxy,
                         user_agent)  # type: ignore
...
class PlaylistsSearch(SearchCore):
    ...
    def __init__(self, query: str, limit: int = 20, language: str = 'en', region: str = 'US',
        ...
        super().__init__(query, limit, language, region, SearchMode.playlists, timeout, proxy,
                         user_agent)  # type: ignore
...
class CustomSearch(SearchCore):
    ...
    def __init__(self, query: str, searchPreferences: str, limit: int = 20, language: str = 'en', region: str = 'US',
                 ...
                 user_agent: str = None):
        self.searchMode = (True, True, True)
        super().__init__(query, limit, language, region, searchPreferences, timeout, proxy, user_agent)  # type: ignore
...
class ChannelSearch(ChannelSearchCore):
    ...
    def __init__(self, query: str, browseId: str, language: str = 'en', region: str = 'US',
                 searchPreferences: str = "EgZzZWFyY2g%3D", timeout: Optional[int] = None, proxy: dict = None,
                 user_agent: str = None):
        super().__init__(query, language, region, searchPreferences, browseId, timeout, proxy,
                         user_agent)  # type: ignore
